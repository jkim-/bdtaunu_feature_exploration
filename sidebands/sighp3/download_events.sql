...
SELECT * FROM
sideband_generic INNER JOIN event_labels_generic_augmented USING (eid) WHERE sideband_generic.sighp3_sideband = 1;
...
SELECT * FROM
sideband_data INNER JOIN event_labels_data USING (eid) WHERE sideband_data.sighp3_sideband = 1;
